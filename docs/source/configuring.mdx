...
<ExpansionPanel title="Need help setting environment variables?">
  ...
  <Tabs>
    ...
    <Tab label="Unix-based systems (Linux/macOS)">

      <Tab label="Temporary (current terminal session only)">
      ...
      <Tab label="Permanent (in your shell profile)">
    ...
    <Tab label="Windows">
      <Tab label="Command Prompt (temporary)">
      ...
      <Tab label="PowerShell (temporary)">
      ...
      <Tab label="Permanent (System Variables)">
