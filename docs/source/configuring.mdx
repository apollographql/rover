...
All Rover commands that communicate with [GraphOS](/graphos/) require an API key. GraphOS supports the following types of API keys: graph API keys, subgraph API keys, and personal API keys.
