...
The `rover config auth` command is interactive. In your project settings, [authenticate using an environment variable](./configuring#with-an-environment-variable).
