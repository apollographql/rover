...
On your local development machine, use a personal API key and provide it to Rover with the [<code>rover config auth</code> command](./configuring#via-the-auth-command).
