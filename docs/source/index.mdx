...
**Rover** is a CLI for managing and maintaining graphs with [Apollo Studio](/studio/):
...
Rover helps you safely publish and fetch GraphQL schemas (both [federated](./subgraphs/) and [monolithic](./graphs/)) from the Apollo schema registry.
