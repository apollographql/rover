...
> Rover does _not_ currently provide client-specific features, such as code generation or [client checks](./validating-client-operations). For these features, continue using the [Apollo CLI](/devtools/cli/).
