...
A **contract** is a variant that is the result of filtering on a source variant:
...
TODO(caydie) is this correct? I'm assuming you always have to authn to rover with studio 
