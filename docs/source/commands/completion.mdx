...
If you install Rover via [Homebrew](../getting-started#unofficial-methods), shell completions are automatically set up for you. You don't need to manually generate or install completion scripts.
