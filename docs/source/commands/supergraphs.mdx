...
> ⚠️ Warning: Future versions of `rover supergraph compose` will fail without specifying an exact federation version. Set this configuration to prevent breaking changes in future Rover versions.
