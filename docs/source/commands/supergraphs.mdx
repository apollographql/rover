...
The `supergraph.yaml` file supports variable expansion using [the same syntax as Apollo Router](https://www.apollographql.com/docs/router/configuration/overview/#variable-expansion).
