...
* The (online) [Enterprise license](/graphos/routing/graphos-features#the-enterprise-license) that a router connected to GraphOS gets from [Apollo Uplink](/federation/managed-federation/uplink/)
* [Offline Enterprise license](/graphos/routing/license#offline-license)
