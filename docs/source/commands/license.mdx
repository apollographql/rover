...
* The (online) [Enterprise license](/graphos/routing/license#offline-license) that a router connected to GraphOS gets from [Apollo Uplink](/federation/managed-federation/uplink/)
