...
To save introspection JSON instead of SDL, pass `--introspection-json` to `graph introspect`. See [Introspection JSON output](#introspection-json-output) for details.
