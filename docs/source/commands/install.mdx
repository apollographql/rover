...
| ------ | ----------- | -------------- | ------- |
| `supergraph` | Federation supergraph composition binary | `latest-2` or exact `=X.Y.Z` (Federation 2 only—Federation 1 versions are rejected) | `supergraph@latest-2`, `supergraph@=2.8.0` |
