...
Run all configured checks for the subgraph before publishing. If any of the checks fail a publish operation will not continue and an error will be displayed instead.
