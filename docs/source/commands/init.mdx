...
When the `init` wizard is complete, you can run `rover dev` to start everything together:
...
Read the full guide to [Running the Apollo MCP Server](https://www.apollographql.com/docs/apollo-mcp-server/run).
