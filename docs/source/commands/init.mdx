...
- (Coming Soon) **Start a GraphQL API with recommended libraries**
    - Select this option if you want to integrate data that's not accessible via a REST API. This option helps you set up a GraphQL API using the Apollo Server library.
