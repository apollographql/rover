...
If you stop a _secondary_ `rover dev` process (by pressing `CTRL+C`), the session recomposes its schema _without_ the corresponding subgraph and reloads the router.
