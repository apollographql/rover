...
If you plan to use these [GraphOS Router features](/graphos/routing/graphos-features#graphos-router-features) or the @connect directive in your schema you need to provide the APOLLO_KEY and APOLLO_GRAPH_REF environment variables.
