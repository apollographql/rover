...
By default, `rover dev` uses the latest available version of the router, composition, and MCP server plugins, resolved automatically at download time. You can override any of these versions:
