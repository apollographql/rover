...
use rover_client::shared::{
    CheckRequestSuccessResult, CheckWorkflowResponse, FetchResponse, GraphRef, SdlType,
};
...
mod tests {
    ...
    use rover_client::{
        ...
        shared::{
            ChangeSeverity, CheckTaskStatus, OperationCheckResponse, SchemaChange, Sdl, SdlType,
        },
    };
