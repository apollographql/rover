...
#### Homebrew
While we reccomend using one of the other installation methods above, we do have a homebrew reciepe `brew install rover`. The code for this reciepe is in the [homebrew-core repo](https://github.com/Homebrew/homebrew-core/blob/master/Formula/r/rover.rb).
