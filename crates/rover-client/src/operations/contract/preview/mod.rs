...
/// Timeout for a single status-check attempt, independent of the overall poll
/// budget (reusing the overall poll budget here would let one hung attempt
/// consume the whole thing, leaving no room to poll again.
